...
trait ListsResources {
   ...
   * <br />createUserList calls http://api.twitter.com/1.1/lists/create.json
   *
   ...
   * <br />getUserList calls http://api.twitter.com/1.1/lists.json
   ...
   * @see <a href="https://dev.twitter.com/docs/api/1.1/get/lists/list">GET lists | Twitter Developers</a>
   * @since Twitter4S 1.0.0
   */
   ...
   * <br />getUserListStatuses calls http://api.twitter.com/1.1/lists/statuses.json
   *
   * @param listSpecificInfo The list specific information(set list id or set screen name or user id and slug)
   ...
   * @since Twitter4S 1.0.0
   */
  def getUserListStatuses(listSpecificInfo: UserList.SpecificInfo, paging: Paging): ResponseList[Status]
   ...
   * <br />getUserListMembers calls http://api.twitter.com/1.1/lists/members.json
   *
   * @param listSpecificInfo The list specific information(set list id or set screen name or user id and slug)
   * @param cursor Breaks the results into pages. A single page contains 20 lists. Provide a value of -1 to begin paging. Provide values as returned to in the response body's next_cursor and previous_cursor attributes to page back and forth in the list.
   ...
   * <br />addUserListMembers calls http://api.twitter.com/1.1/lists/members/create_all.json
   ...
   * <br />deleteUserListMember calls http://api.twitter.com/1.1/lists/members/destroy.json
   *
   * @param listSpecificInfo The list specific information(set list id or set screen name or user id and slug)
   ...
   * <br />showUserListMembership calls http://api.twitter.com/1.1/lists/members/show.json
   *
   * @param listSpecificInfo The list specific information(set list id or set screen name or user id and slug)
   ...
   * <br />getUserListSubscribers calls http://api.twitter.com/1.1/lists/subscribers.json
   *
   * @param listSpecificInfo The list specific information(set list id or set screen name or user id and slug)
   * @param cursor Breaks the results into pages. A single page contains 20 lists. Provide a value of -1 to begin paging. Provide values as returned to in the response    body's next_cursor and previous_cursor attributes to page back and forth in the list.
   * @return the members of the specified list.
   ...
   * <br />createUserListSubscribers calls http://api.twitter.com/1.1/list/subscribers/create.json
   *
   * @param listSpecificInfo The list specific information(set list id or set screen name or user id and slug)
   * @return the updated list
   * @throws TwitterException when Twitter service or network is unavailable
   ...
   * <br />destroyUserListSubscription calls http://api.twitter.com/1.1/subscribers/destroy.json
   *
   * @param listSpecificInfo The list specific information(set list id or set screen name or user id and slug)
   * @return the updated list
   * @throws TwitterException when Twitter service or network is unavailable
   ...
   * <br />showUserListSubscriptions calls http://api.twitter.com/1.1/lists/subscribers/show.json
   *
   * @param listSpecificInfo The list specific information(set list id or set screen name or user id and slug)
   * @param userId The id of the user who you want to know is a member or not of the specified list.
   * @return the updated list
