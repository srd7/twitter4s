 ...
 */
trait SavedSearchesResources {
  /**
   * Returns the authenticated user's saved search queries.
   * <br />This method calls twitter4j.Twitter.getSavedSearches.
   * <br />getSavedSearchs calls http://api.twitter.com/1.1/saved_searches.json
   *
   ...
   * <br />showSavedSearches calls http://api.twitter.com/1.1/saved_searches/show/:id.json
   *
   ...
   * <br />createSavedSearches calls http://api.twitter.com/1.1/saved_searches/saved_searches/create.json
   *
   ...
   * <br />destroySavedSearches calls http://api.twitter.com/1.1/saved_searches/destroy/id.json
   *
