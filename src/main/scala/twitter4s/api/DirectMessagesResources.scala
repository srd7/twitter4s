...
trait DirectMessagesResources {
   ...
   * <br />getDirectMessages calls http://api.twitter.com/1.1/direct_messages
   *
   ...
   * <br />getSentDirectMessages calls http://api.twitter.com/1.1/direct_messages/sent
   *
   * @param paging (optional) controls pagination. Supports since_id, max_id, count and page parameters.
   * @return List
   * @throws TwitterException when Twitter service or network is unavailable
   ...
   * <br />sendDirectMessage calls http://api.twitter.com/1.1/direct_messages/new
   ...
   * <br />destroyDirectMessage calls http://api.twitter.com/1.1/direct_messages/destroy
   *
   ...
   * <br />showDirectMessage calls http://api.twitter.com/1.1/direct_messages/show/:id.json
   *
   * @param id message id
   * @return DirectMessage
   * @throws TwitterException when Twitter service or network is unavailable
